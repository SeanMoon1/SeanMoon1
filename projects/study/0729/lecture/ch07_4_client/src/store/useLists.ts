...
export const useLists = () => {
  ...
  // 직접 useSelector 사용 (변환 로직이 없으므로)
  const listidCardidOrders = useSelector((state: AppState) => state.listidCardidOrders)
  const listidOrders = useSelector((state: AppState) => state.listidOrders)
